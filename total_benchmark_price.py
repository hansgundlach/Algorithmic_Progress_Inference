...
def plot_benchmark_price_vs_time(
    ...
    if 'overall_ci_x_dates' in locals() and overall_ci_x_dates is not None and overall_ci_y_lower is not None:
        ci_alpha = 0.2
        ci_color = 'blue'
    ...
    if 'overall_trend_x_dates' in locals() and overall_trend_x_dates is not None and overall_trend_y_pred is not None:
    ...
    if 'record_trend_x_dates' in locals() and record_trend_x_dates is not None and record_trend_y_pred is not None:
