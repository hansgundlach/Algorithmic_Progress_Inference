"""
AIME Pareto Frontier with Model Names (ICML Style)
...
def main():
    ...
    parser.add_argument("--out", default="../figures/aime_pareto_with_names.png")
    ...
    # Figure size — shared with aime_pareto_frontier.py
    ...
    # =========================================================================
    # AXIS LIMITS — shared with aime_pareto_frontier.py
    # =========================================================================
    XMIN = PAIR_XMIN
    XMAX = PAIR_XMAX
    YMIN = PAIR_YMIN
    ...
    # Fixed margins — must match aime_pareto_frontier.py for identical axes boxes
