"""
AIME Pareto Frontier Analysis (Epoch AI Style)
...
def main():
    ...
    parser.add_argument("--out", default="../figures/aime_pareto_frontier.png")
    ...
    ax.set_ylabel("AIME Score (logits)", fontsize=FONT_SIZE_LABEL)
